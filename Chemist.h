...
// Constant int variable for if the chemist has yet to find a substance
const int chemistKnowsNoSubstances = 0;
...
class Chemist{
 public:
  ...
  int CheckSubstance(Substance theSubstance);
  ...
  void AddSubstance(Substance theSubstance, int index);
 // Name: IncrementQuantity(Substance)
  ...
  void IncrementQuantity(Substance theSubstance);
  ...
  bool CheckQuantity(Substance substanceOne, Substance substanceTwo);
  ...
  Substance GetSubstance(int substanceIndex);
