...
// Delimeter constant for reading in the text of the file
const char DELIMETER = ',';
// Constant for largest value in menu of options
const int MAX_USER_INPUT = 5;
// Constant for smallest value in menu of options
const int MIN_USER_INPUT = 1;
// Constant for false boolean
const bool FALSE_STRING = false;
// Constant for true boolean
const bool TRUE_STRING = true;
// Constants for all of the menu options
const int OPTION_ONE = 1;
const int OPTION_TWO = 2;
const int OPTION_THREE = 3;
const int OPTION_FOUR = 4;
const int OPTION_FIVE = 5;
// Constant for how many elements there are. Used with % to randomly select an element from array
const int NUMBER_ELEMENTS = 29;
// Constant for the first option out of 283 substances
const int FIRST_OPTION = 1;
// Constant for displaying all of the known substances when trying to combine substances
const int LIST_KNOWN_SUBSTANCES = -1;
// Constant for if the 2 substances cannot be combined
const int CANNOT_COMBINE = -1;
...
public:
 ...
 // Name: CombineSubstances()
  ...
  int SearchFormulas(string substanceNameOne, string substanceNameTwo);
  // Name: CalcScore()
